...
export const PROVIDER_REGISTRY: Record<string, ProviderConfig> = {
  ...
  ollama: {
    ...
    supportedTypes: ['llm', 'embedding', 'lmm', 'omni'],
  ...
  zhipu: {
    ...
    supportedTypes: ['llm', 'embedding', 'image', 'tts', 'lmm', 'omni'],
  ...
  aliyun: {
    ...
    supportedTypes: ['llm', 'embedding', 'image', 'lmm', 'omni'],
  ...
  volcengine: {
    ...
    supportedTypes: ['llm', 'tts', 'asr', 's2s', 'omni'],
  ...
  custom: {
    ...
    supportedTypes: ['llm', 'embedding', 'tts', 'asr', 'image', 'lmm', 's2s', 'omni'],
    requireApiKey: false,
  },
};
